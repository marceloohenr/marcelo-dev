...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="focus-ring fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-4 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full border border-state-success/70 bg-state-success text-slate-950 shadow-brand transition-all duration-200 hover:-translate-y-0.5 hover:scale-[1.02] md:bottom-[calc(1.25rem+env(safe-area-inset-bottom))] md:right-5 lg:w-auto lg:gap-2 lg:px-5 xl:bottom-[calc(1.5rem+env(safe-area-inset-bottom))] xl:right-6"
